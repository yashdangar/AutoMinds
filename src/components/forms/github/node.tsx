...
type GitHubAction = "createGist" | "createIssue" | "createPullRequest" | "deleteBranch"
...
const actionOptions: ActionOption[] = [
  { value: "createGist", label: "Create Gist", description: "Creates a new gist." },
  { value: "createIssue", label: "Create Issue", description: "Create a new issue." },
  { value: "createPullRequest", label: "Create Pull Request", description: "Create a new pull request and merge it (optional)." },
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="space-y-6">
          <div>
            ...
            <Select onValueChange={(value) => setAction(value as GitHubAction)} value={action}>
          ...
          {(action === "createIssue" || action === "createPullRequest" || action === "createGist") && (
            <div>
          ...
          {(action === "createPullRequest" || action === "deleteBranch") && (
            <div>
              <Label htmlFor="branch" className="text-lg font-semibold">Branch name:</Label>
              <Input 
                id="branch" 
          ...
          {action === "createGist" && (
            <>
              <div>
                <Label htmlFor="fileName" className="text-lg font-semibold">File Name:</Label>
                <Input 
                  id="fileName" 
